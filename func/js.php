...
class P2JS {
	...
	function enqueue_scripts() {
		...
		if ( is_user_logged_in() ) {
			...
			wp_enqueue_script( 'jeditable', N2_JS_URL . '/jquery.jeditable.js', array( 'jquery' )  );
		}

		//bust the cache here	
		wp_enqueue_script( 'p2js', N2_JS_URL . '/p2.js', array( 'jquery', 'utils' ), filemtime(N2_JS_PATH . '/p2.js') );
		...
		wp_enqueue_script( 'scrollit', N2_JS_URL .'/jquery.scrollTo-min.js', array( 'jquery' )  );

		// wp_enqueue_script( 'wp-locale', N2_JS_URL . '/wp-locale.js', array(), filemtime(N2_JS_PATH . '/wp-locale.js') );
